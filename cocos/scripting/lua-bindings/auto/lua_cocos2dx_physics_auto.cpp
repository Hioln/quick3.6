...
int lua_cocos2dx_physics_PhysicsBody_setRotation(lua_State* tolua_S)
{
	int argc = 0;
	cocos2d::PhysicsBody* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_physics_PhysicsBody_setRotation'", nullptr);
		return 0;
	}
#endif
	...
	{
		double arg0;
		ok &= luaval_to_number(tolua_S, 2, &arg0, "cc.PhysicsBody:setRotation");
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_physics_PhysicsBody_setRotation'", nullptr);
			return 0;
		}
	...
	luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.PhysicsBody:setRotation", argc, 1);
	return 0;
...
int lua_register_cocos2dx_physics_PhysicsBody(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"PhysicsBody");
		...
		tolua_function(tolua_S, "setRotation", lua_cocos2dx_physics_PhysicsBody_setRotation);
